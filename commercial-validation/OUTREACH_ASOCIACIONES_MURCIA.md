# Campaña de Outreach Institucional — Asociaciones Neurodivergencia (Región de Murcia)
**MIRATEA by Solutech** · Remitente: Xavi Alonso (`xavi@miratea.es`) · Web: [https://miratea.es](https://miratea.es)

---

## 1. Resumen Ejecutivo y Matriz de Deduplicación

| ID Original | Asociación | Categoría | Ubicación | Email / Canal | Prioridad | Estado / Acción |
|---|---|---|---|---|:---:|---|
| 1 | Lorca Activa TDAH | TDAH | Lorca | `asociacion@lorcaactivatdah.es` | P1 | Borrador P1 listo (Cercanía Lorca) |
| 2 | Talentismo (Astrade) — Del. Lorca | TEA | Lorca | `atlorca@astrade.es` | P1 | Borrador P1 listo (Cercanía Lorca) |
| 3 & 6 | ASTEAMUR (Puerto Lumbreras + Central) | TEA | P. Lumbreras / Murcia | `info@asteamur.org` | P1 | **Fusionado 3 y 6** (Cercanía P. Lumbreras/Lorca + Central) |
| 11 | Teayuda (TEA Noroeste) | TEA | Caravaca de la Cruz | `teayudanoroeste@gmail.com` | P1 | Borrador P1 listo (Comarca Noroeste / cercanía) |
| 4 | FAUM (Fed. Autismo R. Murcia) | TEA - Fed. | Murcia | `info@autismomurcia.org` | P2 | Borrador P2 listo (Institucional + consulta difusión federada) |
| 5 | Talentismo (Astrade) — Sede General | TEA | Molina de Segura | `hola@talentismo.org` | P2 | Borrador P2 listo (~30 años trayectoria) |
| 7 | ABAMUR | TEA | Murcia | `abamur@abamur.org` | P2 | Borrador P2 listo (Enfoque estructurado / ABA) |
| 8 | Aspermur (Asperger Murcia) | TEA | Puente Tocinos | `info@aspermur.org` | P2 | Borrador P2 listo (TEA 1 / Asperger) |
| 9 | Autismo Somos Todos | TEA | Cartagena | `info@autismosomostodos.org` | P2 | Borrador P2 listo (Cartagena) |
| 10 | Ingloba TEA | TEA | R. de Murcia | `info@inglobatea.es` | P2 | Borrador P2 listo (Inclusión regional) |
| 15 | ADAHI Murcia | TDAH | Espinardo / Cartagena | `adahimurcia.gestion@hotmail.com` | P2 | Borrador P2 listo (Buzón principal gestión) |
| 16 | Águilas Vida Activa | TDAH | Águilas | `aguilasvidaactiva@hotmail.com` | P2 | Borrador P2 listo (Cercanía comarcal Águilas) |
| 18 | Talentos — Altas Capacidades | Altas Cap. | Murcia | `talentos@altascapacidadesmurcia.org` | P2 | Borrador P2 listo (Enfoque frustración / perfeccionismo) |
| 12 | TEA Yecla | TEA | Yecla | `teayecla@hotmail.es` | P3 | Borrador P3 listo (Altiplano) |
| 13 | Fundación Estrella Azul | TEA | Alcantarilla | `info@fundacionestrellaazul.org` | P3 | Borrador P3 listo (TEA) |
| 14 | Crece con Dabadá | TEA | Churra, Murcia | `crececondabada@crececondabada.org` | P3 | Borrador P3 listo (Preadolescencia / adolescencia) |
| 17 | ADA+HI | TDAH | Torre Pacheco | `adahimurcia@hotmail.com` | P3 | **Deduplicación recomendada**: En reserva para no duplicar ID 15 |
| 19 | FEAADAH | TDAH - Fed. | Cartagena | Formulario web | — | **Acción manual**: `feaadah.org/es/contacto` |
| 20 | aMuACI | Altas Cap. | Murcia | Formulario web | — | **Acción manual**: `amuaci.es/contacto` |

---

## 2. Borradores Prioridad 1 (Lorca y Comarca)

### Borrador 1 — Lorca Activa TDAH
- **Destinatario**: `asociacion@lorcaactivatdah.es`
...
### Borrador 2 — Talentismo (Astrade) — Delegación Lorca
- **Destinatario**: `atlorca@astrade.es`
...
### Borrador 3 — ASTEAMUR (Centro Puerto Lumbreras y Sede Central Murcia) [FUSIONADO]
- **Destinatario**: `info@asteamur.org`
...
### Borrador 4 — Teayuda (TEA Noroeste)
- **Destinatario**: `teayudanoroeste@gmail.com`
...
## 3. Borradores Prioridad 2 (Regionales y Especializadas)

### Borrador 5 — FAUM (Federación Autismo Región de Murcia)
- **Destinatario**: `info@autismomurcia.org`
- **Asunto**: Presentación de MIRATEA a FAUM: tecnología de autorregulación para familias con TEA en la Región
- **Cuerpo**:
```text
Estimado equipo de FAUM,
...
### Borrador 6 — Talentismo (Astrade) — Sede General
- **Destinatario**: `hola@talentismo.org`
...
### Borrador 7 — ABAMUR
- **Destinatario**: `abamur@abamur.org`
...
### Borrador 8 — Asociación Asperger Murcia (Aspermur)
- **Destinatario**: `info@aspermur.org`
...
### Borrador 9 — Autismo Somos Todos
- **Destinatario**: `info@autismosomostodos.org`
...
### Borrador 10 — Ingloba TEA
- **Destinatario**: `info@inglobatea.es`
...
### Borrador 11 — ADAHI Murcia (Buzón Principal Gestión)
- **Destinatario**: `adahimurcia.gestion@hotmail.com`
...
### Borrador 12 — Águilas Vida Activa
- **Destinatario**: `aguilasvidaactiva@hotmail.com`
...
### Borrador 13 — Talentos — Altas Capacidades Región de Murcia
- **Destinatario**: `talentos@altascapacidadesmurcia.org`
...
## 4. Borradores Prioridad 3 (Otras Localidades y Casos Específicos)

### Borrador 14 — TEA Yecla
- **Destinatario**: `teayecla@hotmail.es`
...
### Borrador 15 — Fundación Estrella Azul
- **Destinatario**: `info@fundacionestrellaazul.org`
...
### Borrador 16 — Crece con Dabadá
- **Destinatario**: `crececondabada@crececondabada.org`
...
### Caso 17 — ADA+HI (Torre Pacheco) [Recomendación Estratégica]
- **Email registrado**: `adahimurcia@hotmail.com`
- **Ubicación**: Torre Pacheco
- **Diagnóstico**: Correo histórico / alternativo de ADAHI Murcia (ver Contacto 11 / ID 15 `adahimurcia.gestion@hotmail.com`).
- **Plan de Acción**: Mantenido en reserva para no duplicar el contacto inicial. Si tras 10-14 días no se obtiene respuesta en el correo de gestión, se activará como canal secundario.

---

## 5. Acciones Manuales Pendientes (Vía Formulario Web)

### Acción Manual 1 — FEAADAH (Federación TDAH)
- **Canal**: `https://feaadah.org/es/contacto`
- **Texto propuesto para formulario**:
```text
Nombre: Xavi Alonso
Email: xavi@miratea.es
Asunto: MIRATEA — Herramienta murciana de autorregulación y autonomía para familias con TDAH
Mensaje:
Estimado equipo de FEAADAH,

Me llamo Xavi Alonso y soy el desarrollador de MIRATEA (https://miratea.es), desarrollada en Lorca (Región de Murcia), una aplicación concebida para apoyar a familias con niños con TDAH en su autonomía diaria (rutinas visuales, descomposición de metas en micropasos y gestión emocional sin rachas punitivas ni sobrecarga). 

Nos ponemos en contacto con vosotros como federación de referencia para explorar vías de presentación de la herramienta y conocer si consideraríais interesante su difusión a vuestras entidades federadas como recurso complementario para el hogar.

Quedo a vuestra disposición para ampliar cualquier información o mantener una breve reunión telemática cuando os resulte oportuno.

Un cordial saludo,
Xavi Alonso (xavi@miratea.es) - MIRATEA by Solutech
https://miratea.es
```

### Acción Manual 2 — aMuACI (Asociación Altas Capacidades)
- **Canal**: `https://amuaci.es/contacto`
- **Texto propuesto para formulario**:
```text
Nombre: Xavi Alonso
Email: xavi@miratea.es
Asunto: MIRATEA — Apoyo a la organización y bienestar emocional en Altas Capacidades
Mensaje:
Hola, estimado equipo de aMuACI,

Me pongo en contacto con vosotros desde Lorca para presentaros MIRATEA (https://miratea.es), una aplicación pensada para acompañar a niños con altas capacidades y neurodivergencia en el desarrollo de su autonomía (organización de proyectos complejos en micropasos, gestión del perfeccionismo y la frustración, y un Rincón de Calma con cero mecánicas punitivas).

Conociendo vuestra dedicación en la Región de Murcia, me encantaría enseñaros la plataforma y valorar si puede ser de utilidad para las familias socias de vuestra entidad.

Quedo a vuestra total disposición para una breve llamada o videollamada sin compromiso.
...
## 6. Registro de Envíos y Log de Seguimiento (Tiempo Real)
...
| 4 | FAUM (Federación Autismo Región de Murcia) | `info@autismomurcia.org` | 2026-09-08 23:12:48 | Presentación de MIRATEA a FAUM: tecnología de autorregulación para familias con TEA en la Región | **enviado** | Prioridad 2 |
| 5 | Talentismo (Astrade) — Sede General | `hola@talentismo.org` | 2026-09-08 23:15:50 | MIRATEA: nueva iniciativa murciana de autorregulación y rutinas para familias con TEA | **enviado** | Prioridad 2 |
