...
* **Fase 6 (Gold Release v1.0 & Rebranding MIRATEA by Solutech)**:
  ...
  - Sistema de PIN parental personalizable con invisibilidad en pantalla, verificación de contraseña de cuenta, protección anti fuerza bruta (RateLimiter) y recuperación mediante token/código seguro por correo (soporte PKCE `?code=...` y almacenamiento en `sessionStorage` para persistencia tras refresco manual F5).
